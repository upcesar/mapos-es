        ...
        if ($this->form_validation->run('os') == false) {
           $this->data['custom_error'] = (validation_errors() ? true : false);
            ...
            if ( is_numeric($id = $this->os_model->add('os', $data, true)) ) {
                $this->session->set_flashdata('success','La Orden de Servicio se agregó correctamente, puede agregar productos o servicios a la Orden de Servicio en las pestañas de "Productos" y "Servicios"!');
    ...
    function editar() {
        ...
        if ($this->form_validation->run('os') == false) {
            ...
            if ($this->os_model->edit('os', $data, 'idOs', $this->input->post('idOs')) == TRUE) {
                $this->session->set_flashdata('success','Os editada con éxito!');
