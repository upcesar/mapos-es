...
<div class="span12" style="margin-left: 0">
    <form method="get" action="<?php echo current_url(); ?>">
        <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'aArquivo')){ ?>
             <div class="span3">
                <a href="<?php echo base_url();?>index.php/arquivos/adicionar" class="btn btn-success span12"><i class="icon-plus icon-white"></i> Agregar Archivo</a>
            </div>  
        <?php } ?>
        
        <div class="span5">
            <input type="text" name="pesquisa"  id="pesquisa"  placeholder="Escriba el nombre del documento para buscar" class="span12" value="<?php echo $this->input->get('pesquisa'); ?>" >        
        </div>
        <div class="span3">
...
<div id="modal-excluir" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-body">
    ...
    <h5 style="text-align: center">Desea realmente eliminar el archivo?</h5>
  </div>
