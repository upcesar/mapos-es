...
<html lang="pt-br">
  <head>
    <meta charset="utf-8">
    <title>Conectar - Área de Cliente</title>
  ...
  <body>
    ...
    <div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-list"></i> Menu</a>
      <ul>
        ...
        <li class="<?php if(isset($menuOs)){echo 'active';};?>"><a href="<?php echo base_url()?>index.php/conecte/os"><i class="icon icon-tags"></i> <span>Ordenes de Servicio</span></a></li>
