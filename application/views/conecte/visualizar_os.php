                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 18%; text-align: center">#O.S/Reparación: <span ><?php echo $result->idOs?></span></br> </br> <span>Fecha Inicio: <?php echo date('d/m/Y',  strtotime($result->dataInicial))?></span></br> </br> 
                                        <span>Fecha Cierre: <?php echo date('d/m/Y',  strtotime($result->dataFinal))?></span></td >
